...
const DashboardScreen = ({ route, navigation }) => {
    ...
    // Helper to ensure data arrays exist and have content
    const getChartData = (dataArray) => {
        if (!dataArray || dataArray.length === 0) return [0];
        return dataArray.slice(0, 50); // Show first 50 points
    };
            ...
            <View style={styles.card}>
                ...
                <LineChart
                    data={{
                        ...
                        datasets: [
                            {
                                data: getChartData(sensorData.vibration?.x),
                            },
                        ],
                    }}
            ...
            <View style={styles.card}>
                ...
                <LineChart
                    data={{
                        ...
                        datasets: [
                            {
                                data: getChartData(sensorData.magnetic?.x),
                            },
                        ],
                    }}
                    width={screenWidth - 64}
